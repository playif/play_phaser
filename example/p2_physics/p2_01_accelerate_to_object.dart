...
class p2_01_accelerate_to_object extends State {
  ...
  update() {
    ...
    if (cursors.left.isDown) {body.rotateLeft(100);}   //ship movement
    else if (cursors.right.isDown){body.rotateRight(100);}
    else {body.setZeroRotation();}
    if (cursors.up.isDown){body.thrust(400);}
    else if (cursors.down.isDown){body.reverse(400);}
  }
