...
class Tween {
  ...
  Tween to(Map<int, num> properties, [num duration=1000, tween.TweenEquation ease=null, bool autoStart=false, double delay=0.0, int repeat=0, bool yoyo=false]) {
    return _setTween(properties, tween.Tween.to, duration, ease, autoStart, delay, repeat, yoyo);
  }

  Tween from(Map<int, num> properties, [num duration=1000, tween.TweenEquation ease=null, bool autoStart=false, double delay=0.0, int repeat=0, bool yoyo=false]) {
