...
//    if (duration == null) { duration = 50; }
  ...
  static const int A = "A".codeUnitAt(0);
  static const int B = "B".codeUnitAt(0);
  static const int C = "C".codeUnitAt(0);
  static const int D = "D".codeUnitAt(0);
  static const int E = "E".codeUnitAt(0);
  static const int F = "F".codeUnitAt(0);
  static const int G = "G".codeUnitAt(0);
  static const int H = "H".codeUnitAt(0);
  static const int I = "I".codeUnitAt(0);
  static const int J = "J".codeUnitAt(0);
  static const int K = "K".codeUnitAt(0);
  static const int L = "L".codeUnitAt(0);
  static const int M = "M".codeUnitAt(0);
  static const int N = "N".codeUnitAt(0);
  static const int O = "O".codeUnitAt(0);
  static const int P = "P".codeUnitAt(0);
  static const int Q = "Q".codeUnitAt(0);
  static const int R = "R".codeUnitAt(0);
  static const int S = "S".codeUnitAt(0);
  static const int T = "T".codeUnitAt(0);
  static const int U = "U".codeUnitAt(0);
  static const int V = "V".codeUnitAt(0);
  static const int W = "W".codeUnitAt(0);
  static const int X = "X".codeUnitAt(0);
  static const int Y = "Y".codeUnitAt(0);
  static const int Z = "Z".codeUnitAt(0);
  static const int ZERO = "0".codeUnitAt(0);
  static const int ONE = "1".codeUnitAt(0);
  static const int TWO = "2".codeUnitAt(0);
  static const int THREE = "3".codeUnitAt(0);
  static const int FOUR = "4".codeUnitAt(0);
  static const int FIVE = "5".codeUnitAt(0);
  static const int SIX = "6".codeUnitAt(0);
  static const int SEVEN = "7".codeUnitAt(0);
  static const int EIGHT = "8".codeUnitAt(0);
  static const int NINE = "9".codeUnitAt(0);
